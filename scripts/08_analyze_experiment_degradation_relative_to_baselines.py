...
2. How much additional error does each home perturbation introduce compared with
   the ideal home baseline E1?
3. Which experiments degrade most on clinical gait features?
4. At which frames does a perturbed experiment become worse than the baseline?

Recommended interpretation
--------------------------
- E0 is the neutral technical baseline.
- E1 is the ideal home/living-room baseline.
- E2+ are perturbation conditions such as camera angle, lighting, occlusion, or combinations.
